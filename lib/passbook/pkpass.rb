  ...
  class PKPass
    ...
    protected
      ...
      def createSignature manifest
        ...
        ca    = OpenSSL::X509::Certificate.new File.read(Passbook.intermediate_cert)
        pk7   = OpenSSL::PKCS7.sign p12.certificate, p12.key, manifest.to_s, [ca], OpenSSL::PKCS7::BINARY | OpenSSL::PKCS7::DETACHED
